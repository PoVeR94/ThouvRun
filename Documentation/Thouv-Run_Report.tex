...
% \checkmark n'existe pas par défaut : on le mappe sur le symbole de pifont
\newcommand{\checkmark}{\ding{51}}

% --- FIX language=CSS pour listings (CSS n'est pas fourni par défaut) ---
\lstdefinelanguage{CSS}{
  morekeywords={@import,@media,@font-face,@keyframes,from,to,important},
  sensitive=true,
  morecomment=[l]{//},
  morecomment=[s]{/*}{*/},
  morestring=[b]",
...
% --- FIX affichage caractères spéciaux/accents dans lstlisting ---
...
\textbf{Problème} : Les weeds du fond n'animaient pas correctement quand on essayait de les faire pivoter tout en faisant l'animation.
